...
export const NavBar = () => {
  return (
    <>
      <nav className=" fixed-top navbar navbar-expand-lg bg-main-light nav-main mb-5 px-2">
        <div className="container">
          <Link className="navbar-brand " to="/">
            <i className="fa-solid fa-utensils text-main"></i>
            <span className=" fw-bolder mx-2 fs-2 text-main">Yummy</span>
          </Link>
          <button
          ...
          >
            <ul className="navbar-nav   col-md-4 mb-2 mb-lg-0">
              ...
              <li className="nav-item position-relative mx-2">
                <Link className="nav-link active" to="/area">
                  Area
                </Link>
              </li>
              <li className="nav-item position-relative mx-2">
                <Link className="nav-link active" to="/ingredient">
                  Ingredient
                </Link>
              </li>
            </ul>
            <ul className="navbar-nav ms-auto  col-md-4 mb-2 mb-lg-0">
              <li className="nav-item position-relative mx-2">
                <Link className="nav-link active" to="/search">
                  <i className="fa-solid fa-magnifying-glass text-main fs-3"></i>
                </Link>
              </li>
            </ul>
            <ul className={`${Style.wrapper} ${" ms-auto row col-md-4"}`}>
              <a
                className={`${Style.icon} ${
                  Style.facebook
                } ${"nav-link  fa-2x"}`}
                target="_blank"
                href="https://www.facebook.com/profile.php?id=100052592744438"
              >
              ...
              <a
                ...
                target="_blank"
                href="https://www.instagram.com/_mohaamed_radwan/"
              >
